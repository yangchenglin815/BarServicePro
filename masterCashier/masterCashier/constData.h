...
//人脸检测接口
const QString c_sHttpFaceTectionOrderAction = "/qynetbarsystem/upload/face/faceDetect";
//提交人脸数据
const QString c_SHttpCommitFaceDataOrderAction = "/qynetbarsystem/uploads/face/facePerson";
