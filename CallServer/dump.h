...
LONG ApplicationCrashHandler(EXCEPTION_POINTERS *pException)
{
	...
	// 构建dump文件路径
	GetLocalTime(&stTime);
    QString path = QDir::toNativeSeparators(QDir::homePath() + "/AppData/Local/Call-Server/Dump");
	...
	// 这里弹出一个错误对话框并退出程序
    TSprintf(szMsg, _T(L"Sorry, Host-Server has crashed, please contact to us for help! \r\ndump file : %s"), szDumpFile);
